...
| **Entra** | [Workload Identity Secret & Permission Hygiene Agent](Entra/WorkloadIdentitySecurityAgent) | Reviews Entra applicatsdaions and service principals for excessive permissions, stale credentials, risky workload identities, and unused app exposure. |
